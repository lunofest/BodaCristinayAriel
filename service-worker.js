const CACHE_NAME = 'cache-v12'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v12',
    'estilos/styles.css?v12',
    'estilos/mediaQueries.css?v12',
    'javascript/script.js?v12',
